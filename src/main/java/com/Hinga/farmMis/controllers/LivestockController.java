...
import com.Hinga.farmMis.services.LivestockService;
...
public class LivestockController {
    ...
    public ResponseEntity<Livestock> createLivestock(@RequestHeader("Authorization") String token,@RequestBody Livestock livestock, @PathVariable Long farmId){
        ...
        ResponseEntity<Livestock> livestock1=ResponseEntity.ok(livestockService.createLivestock(livestock,farmId));
